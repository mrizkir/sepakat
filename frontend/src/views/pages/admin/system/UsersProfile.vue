                ...
                <template v-slot:default>
                  <tbody>
                    <tr>
                      <td width="150">ID</td>
                      <td>
                        {{ $store.getters['auth/AttributeUser']('id') }}
                      </td>
                      <td width="150">EMAIL</td>
                      <td>
                        {{ $store.getters['auth/AttributeUser']('email') }}
                      </td>
                    </tr>
                    <tr>
                      <td width="150">USERNAME</td>
                      <td>
                        {{ $store.getters['auth/AttributeUser']('username') }}
                      </td>
                      <td width="150">CREATED</td>
                      <td>
                        {{
                          $date(
                            $store.getters['auth/AttributeUser']('created_at')
                    ...
                    <tr>
                      ...
                      <td>
                        {{ $store.getters['auth/AttributeUser']('name') }}
                      </td>
                      <td width="150">UPDATED</td>
                      <td>
                        {{
                          $date(
                            $store.getters['auth/AttributeUser']('updated_at')
                          ).format('DD/MM/YYYY HH:mm')
                        }}
                      </td>
                    </tr>
    ...
    computed: {
      photoUser: {
        get() {
          if (this.avatar == null) {
            let photo =
              this.$api.storageURL + '/' + this.$store.getters.User.foto
            return photo
          } else {
            return this.avatar
          }
