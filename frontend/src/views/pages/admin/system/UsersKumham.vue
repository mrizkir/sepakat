                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar flat color="white">
                                <v-toolbar-title>DAFTAR USERS KANWIL HUKUM DAN HAM</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
...
export default {
    ...
    created () {
        this.breadcrumbs = [
            ...
            {
                text: 'USERS KANWIL HUKUM DAN HAM',
                disabled: true,
                href: '#',
            }
        ];
        ...
        save () {
            if (this.$refs.frmdata.validate())
            {
                ...
                if (this.editedIndex > -1) 
                {
                    ...
                    this.$ajax.post('/system/userskumham/store',
                        {
                            name: this.editedItem.name,
                            email: this.editedItem.email,
                            nomor_hp: this.editedItem.nomor_hp,
