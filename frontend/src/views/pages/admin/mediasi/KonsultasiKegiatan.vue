          ...
          <v-data-table
            ...
            <template v-slot:top>
              <v-toolbar flat color="white">
                ...
                ></v-divider>
                <v-spacer></v-spacer>
                <v-btn color="primary" dark class="mb-2" to="/konsultasi/kegiatan/mediasi/tambah" v-if="dashboard=='paralegal'||dashboard=='kumham'||dashboard=='superadmin'">TAMBAH</v-btn>
              </v-toolbar>
            </template>
            ...
            <template v-slot:item.actions="{ item }">
              <v-btn
                small
                icon
                @click.stop="$router.push('/konsultasi/kegiatan/mediasi/'+item.kegiatan_id+'/detail')">
                <v-icon>
                  mdi-eye
                </v-icon>
              </v-btn>                               
              <v-btn
                small      
                icon                          
                :to="{path:'/konsultasi/kegiatan/mediasi/'+item.kegiatan_id+'/ubah'}"
