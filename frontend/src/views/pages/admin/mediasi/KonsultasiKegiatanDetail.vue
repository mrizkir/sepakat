      ...
      <v-row>
        <v-col cols="12">
          <v-bottom-navigation
            ...
            <v-btn :to="{path:'/konsultasi/kegiatan/mediasi/'+kegiatan_id+'/files'}">
              <span>Files</span>
...
import DK from '@/views/pages/admin/mediasi/DataKegiatan';
  ...
  created () {
    ...
    this.breadcrumbs = [
      ...
      },
      {
        text:'MEDIASI',
        disabled:false,
        href:'/konsultasi/kegiatan/mediasi/'+this.kegiatan_id+'/detail'
      },           
      {
        text:'DETAIL',
        disabled:true,
