  ...
  methods: {
    ...
    save: async function() {
      if (this.$refs.frmdata.validate())
      {
        ...
        await this.$ajax.post('/kegiatan/pemberdayaanmasyarakat/store',
          {
          ...
          setTimeout(() => {
            ...
            this.$router.push('/kegiatan/pemberdayaanmasyarakat/' + data.kegiatan.id + '/files')
            }, 300
          );
        }).catch(() => {
          this.btnLoading = false
    ...
    closedialogfrm() {
      setTimeout(() => {
        this.formdata = Object.assign({}, this.formdefault)
        this.$router.push('/kegiatan/pemberdayaanmasyarakat')
        }, 300
      );
    },
  },
