          ...
          <v-col cols="12"> 
            <v-card>
              <v-card-title>
                ...
                <v-spacer></v-spacer>
                <v-icon                
                  @click.stop="$router.push('/kegiatan/pemberdayaanmasyarakat/')">
                  mdi-close-thick
                </v-icon>
              </v-card-title>
              <v-card-text>
    ...
    methods: {
      ...
      save: async function() {
        if (this.$refs.frmdata.validate()) {
          ...
          await this.$ajax.post('/kegiatan/pemberdayaanmasyarakat/' + this.kegiatan_id,
            {
              _method: 'put',
          ...
          .then(({ data }) => {
            ...
            setTimeout(() => {
              ...
              this.$router.push('/kegiatan/pemberdayaanmasyarakat/' + data.kegiatan.id + '/detail')
              }, 300
            );
          }).catch(() => {
            this.btnLoading = false
      ...
      closedialogfrm() {
        setTimeout(() => {
          this.formdata = Object.assign({}, this.formdefault)
          this.$router.push('/kegiatan/pemberdayaanmasyarakat/' + this.kegiatan_id + '/detail')
        }, 300)
      },
    },
    components: {
