<template>
  <div>
    <v-system-bar app dark class="yellow"></v-system-bar>
    <v-app-bar class="indigo darken-4 yellow--text" dark app>
      <v-app-bar-nav-icon
    ...
    >
      ...
      <v-list expand>
        <v-list-item
          ...
          active-class="yellow"
          color="green"
          v-if="CAN_ACCESS('DASHBOARD-SHOW')"
        >
          <v-list-item-icon class="mr-2">
        ...
        <v-subheader v-if="CAN_ACCESS('DMASTER-GROUP')"
          >DATA MASTER</v-subheader
        >
        <v-list-item
          link
          active-class="yellow darken-4"
          to="/dmaster/jeniskegiatan"
          v-if="CAN_ACCESS('DMASTER-JENISKEGIATAN_BROWSE')"
        >
          <v-list-item-icon class="mr-2">
        ...
        <v-list-item
          link
          to="/laporan/kegiatan"
          v-if="CAN_ACCESS('REPORT-KEGIATAN_BROWSE')"
        >
          <v-list-item-icon class="mr-2">
            <v-icon>mdi-clipboard-list-outline</v-icon>
          </v-list-item-icon>
          <v-list-item-content>
            <v-list-item-title> LAPORAN KEGIATAN </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-subheader v-if="CAN_ACCESS('SYSTEM-SETTING-GROUP')"
          >SETTING</v-subheader
        >
        <v-list-item
          link
        ...
        >
          ...
          <v-list-item-content>
            <v-list-item-title> HAK AKSES PENGGUNA </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item
          link
        ...
        >
          ...
          <v-list-item-content>
            <v-list-item-title> ROLE PENGGUNA </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-divider />
        <v-list-group
        ...
        >
          ...
          <div>
            ...
            <v-list-item
              link
              v-if="CAN_ACCESS('SYSTEM-USERS-HUMKAM_BROWSE')"
              to="/system-users/kumham"
            >
              <v-list-item-icon class="mr-2">
                <v-icon>mdi-account</v-icon>
              </v-list-item-icon>
              <v-list-item-content>
                <v-list-item-title> KANWIL HUKUM DAN HAM </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item
              link
              v-if="CAN_ACCESS('SYSTEM-USERS-PARALEGAL_BROWSE')"
              to="/system-users/paralegal"
            >
              <v-list-item-icon class="mr-2">
                <v-icon>mdi-account</v-icon>
              </v-list-item-icon>
              <v-list-item-content>
                <v-list-item-title> PARALEGAL </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item
              link
              v-if="CAN_ACCESS('SYSTEM-USERS-KADES_BROWSE')"
              to="/system-users/kades"
            >
              <v-list-item-icon class="mr-2">
                <v-icon>mdi-account</v-icon>
              </v-list-item-icon>
              <v-list-item-content>
                <v-list-item-title> KADES </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item
              link
            ...
            >
              ...
              <v-list-item-content>
                <v-list-item-title> PEMDA </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item
              link
              v-if="CAN_ACCESS('SYSTEM-USERS-OBH_BROWSE')"
              to="/system-users/obh"
            >
              <v-list-item-icon class="mr-2">
                <v-icon>mdi-account</v-icon>
              ...
              <v-list-item-content>
                <v-list-item-title> OBH </v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </div>
        </v-list-group>
