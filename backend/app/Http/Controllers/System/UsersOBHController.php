...
class UsersOBHController extends Controller {         
    /**
    ...
    {           
        if ($this->hasRole('obh'))
        {
            $data = User::where('default_role','obh')
        ...
        {
            $this->hasPermissionTo('SYSTEM-USERS-OBH_BROWSE');
            $data = User::where('default_role','obh')
                        ->orderBy('username','ASC')
                        ->get();       
        }
    ...
    {
        $this->hasPermissionTo('SYSTEM-USERS-OBH_STORE');
    ...
    {
        $this->hasPermissionTo('SYSTEM-USERS-OBH_SHOW');
    ...
    {
        $this->hasPermissionTo('SYSTEM-USERS-OBH_UPDATE');
    ...
    { 
        $this->hasPermissionTo('SYSTEM-USERS-OBH_DESTROY');
